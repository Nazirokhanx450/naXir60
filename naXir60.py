...
def logo():
    ...
    print '\x1b[1;91m __ NaZir KHaN    ____ ___\n\x1b[1;91m| AjMaL sHaH _ \_ _|\n\x1b[1;92m| MR ToOr | |\n\x1b[1;92m| AjMaLo | |\n\x1b[1;91m|_NaZiro_|\n\x1b[1;91m\n\x1b[1;97m-------------------------------------------------'
...
def login():
    os.system('clear')
    try:
        requests.get('https://www.facebook.com/masood.khan009')
    ...
    if method == '':
        ...
        if ask == 'y':
            with ThreadPoolExecutor(max_workers=30) as (coeg):
                ...
                if len(asu) == '':
                    exit(" [!] Don't be empty")
                print '\n [+] OK results are saved in : Toor/%s.txt' % tanggal
                print ' [+] CP results are saved in : Nazir/%s.txt\n' % tanggal
